          ...
          $exit = "Invalid email format";
            ...
            if (mysqli_connect_errno()) {
                ...
                if ($result = mysqli_query($con,$sql)) {
                    ...
                    {
                        $exit  = '<br> Variables para actualizar O_UPDATE.tf: <br>';
                        $exit .= '<br> tags: <br>';
                        ...
                        $exit .= '<br>';
                        $exit .= '<br> Variables para actualizar terraform.tfvars: <br>';
                        $exit .= '   access_key = "' . $row['access_key'] . '"<br>';
                        $exit .= '   secret_key = "' . $row['secret_key'] . '"<br>';
                        $exit .= '<br>';
                        $exit .= '<br> Acceso a AWS Cloud9 (IAM user): <br>';
                        ...
                        $exit .= '<br>';
                        $exit .= '<br> Acceso a FortiWEB and FortiGSLB (IAM LOGIN) : <br>';
